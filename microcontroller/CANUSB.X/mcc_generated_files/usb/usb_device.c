...
static void USBCtrlEPServiceComplete(void)
{
    ...
    else    // A module has claimed ownership of the control transfer session.
    {
		if(SetupPkt.DataDir == USB_SETUP_DEVICE_TO_HOST_BITFIELD)
		{
            ...
            //        host performs early termination.  If enabled, the USB_ENABLE_STATUS_STAGE_TIMEOUTS usb_device_config.h
    ...
    if(SetupPkt.bmRequestType == 0x80)
    {
        ...
        switch(SetupPkt.bDescriptorType)
        {
            ...
            case USB_DESCRIPTOR_STRING:
                ...
                //  later it is now mandatory.  This should be defined in usb_device_config.h and should
